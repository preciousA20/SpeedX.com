...
const MeetingRoom = () => {
  ...
  return (
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white bg-gray-800'>
        <div className='relative flex size-full items-center justify-center'>
            ...
            <div className={cn("h-[calc(100vh)] hidden ml-2", { 'show-block': showParticipants})}>
